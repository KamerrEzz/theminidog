...
- Fired alerts appear in the dashboard; configure `ALERT_NOTIFICATIONS` to also receive webhook notifications (see [Section 8](#8-notifications-and-host-health))
